...
## Overview
This project analyzes employee engagement survey responses to understand how employees feel about their work, leadership and growth opportunities.
**The objective is to:**
- Identify areas of high and low employee agreement
- Compare engagement across departments and roles
- Highlight actionable insights to improve employee satisfaction
  
The analysis is presented through an interactive Power BI dashboard designed for clarity and decision-making.
...
- Survey Question
- Response Text (Agree, Disagree, etc.)
  
Incomplete responses were excluded to ensure data accuracy.
...
- Consolidating roles into a single Role column
- Grouping responses into Agree, Disagree, and Not Applicable
- Cleaning duplicate and inconsistent survey questions

---

## Visualization
<p align="center">
<img src="Images/dashboard.png" alt="Employee engagement Survey Analysis Dashboard" width="100%">
<p/>
